  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex p-2 space-x-4 justify-center mt-4">
        <div className="border-2 border-white h-[100px] w-[125px] rounded-lg bg-white flex justify-center items-center">
          <img src={logo1} alt="TATA-IPL-LOGO" />
        </div>
        <div className="border-2 border-white h-[100px] w-[125px] rounded-lg bg-white flex justify-center items-center">
          <img src={logo2} alt="STAR_SPORTS_LOGO" />
        </div>
        <div className="border-2 border-white h-[100px] w-[125px] rounded-lg bg-white flex justify-center items-center p-2">
